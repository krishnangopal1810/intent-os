...
| Product verification gates | Yellow | `make verify` now fails once a product is specified without checks. Product tests are pending implementation. |
...
until the first MVP execution plan adds product code and tests.
